...
function autoPlay() {
    if (!isautoPlaying) {
        intervalID = setInterval(() => {
            ...
            playGame(playerMove);
            document.querySelector('.js-auto-dash-play').innerText = 'Stop Playing'
        }, 1000);
        isautoPlaying = true
    } else {
        clearInterval(intervalID);
        isautoPlaying = false;
        document.querySelector('.js-auto-dash-play').innerText = 'Auto Play'
    }
}
...
document.querySelector('.js-auto-dash-play').addEventListener('click', () => {
    autoPlay();
});

document.querySelector('.reset').addEventListener('click', () => showConfirmation());
